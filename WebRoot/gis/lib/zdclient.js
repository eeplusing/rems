...
Zondy.Map.TianDiTuLayer = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    */
    ...
    maxLevel = maxLevel || obj.numZoomLevels;
    obj.isValidZoomLevel = function (zoomLevel) {
...
/*---------------------------------------------------------GaodeLayer.js---------------------------------------------------------*/
Zondy.Map.GaodeLayer = OpenLayers.Class(OpenLayers.Layer.TMS, {
...
Zondy.Map.ArcGISLayer = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    */
    ...
    getURL: function (bounds) {
        ...
        var res = this.map.getResolution();
        var x = Math.round((bounds.left - this.tileOrigin.lon) / (res * this.tileSize.w));
        var y0 = Math.round((bounds.bottom - this.tileOrigin.lat) / (res * this.tileSize.h)); //按左下角为原点计算
        var y = Math.pow(2, z) - 1 - y0;
...
Zondy.Service.EditDocFeature = OpenLayers.Class(Zondy.Service.EditServiceBase, Zondy.Service.DocLayer, {
    ...
    initialize: function (docName, mapIndex, layerIndex, options) {
        /// <summary>构造函数</summary>
        /// <param name="docName" type="String">文档名称</param>
...
Zondy.Service.QueryDocFeature = OpenLayers.Class(Zondy.Service.QueryServiceBase, Zondy.Service.DocLayer, {
    ...
    initialize: function (queryParam, docName, mapIndex, layerIndex, options) {
        /// <summary>构造函数</summary>
...
/*---------------------------------------------------------SoGouLayer.js---------------------------------------------------------*/
Zondy.Map.SoGouLayer = OpenLayers.Class(OpenLayers.Layer.TileCache, {
    //图层类型，默认为矢量图
    layerType: "vector",
...
Zondy.Map.HeatMapLayer = OpenLayers.Class(OpenLayers.Layer, {
    ...
    CLASS_NAME: "Zondy.Layer.HeatMapLayer"
});